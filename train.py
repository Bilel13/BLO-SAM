...
parser.add_argument('--dataset', type=str, default='pipes', help='experiment_name')
...
parser.add_argument('--ckpt', type=str, default='C:/Users/bilel/BLO-SAM/sam_vit_b_01ec64.pth',help='Pretrained checkpoint')
